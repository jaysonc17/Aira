...
export class ConversationMemory {
    ...
    private readonly maximumMessages:
        number;

    private readonly maximumCharacters:
        number;

    private readonly summarizer:
        ConversationSummarizer | undefined;
    ...
    private async trim():
        ...
        while (
            ...
            const summarized =
                await this.trySummarizeMessages(
                    oldestTurn,
                );
    ...
    private removeLeadingOrphanedAssistants():
        void {
        while (
